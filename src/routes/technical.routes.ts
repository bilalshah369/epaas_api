...
import { listPending, listAll, forwardToEC, rejectApplication, listAppealReview, listExtensionRequests, listAppealsReport, listReviewsReport } from '../controllers/technical.controller';
